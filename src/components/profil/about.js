    ...
    return (
      ...
      <TabPanel value={value} index={0} className={classes.mydiv}>
       <Typography>
         ...
         <span className={classes.titre}>Prénom :</span>   <span className={classes.info}>lamia</span> <br/>
      ...
      <span className={classes.titre}>fonction :</span>           <span className={classes.info}>étudiant(e)</span> 
